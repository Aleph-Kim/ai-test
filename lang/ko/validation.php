...
return [
    ...
    'alpha_dash' => ':attribute은(는) 영어, 숫자, 하이픈(-), 언더바(_)만 포함할 수 있습니다.',
    'alpha_num' => ':attribute은(는) 문자와 숫자만 포함할 수 있습니다.',
    'any_of' => ':attribute은(는) 유효하지 않습니다.',
    'array' => ':attribute은(는) 배열이어야 합니다.',
    'ascii' => ':attribute은(는) 1바이트 영숫자 문자와 기호만 포함해야 합니다.',
    ...
    'enum' => ':attribute의 값이 올바르지 않습니다.',
    'exists' => ':attribute이(가) 존재하지 않습니다.',
    'extensions' => ':attribute에는 다음 확장자 중 하나가 있어야 합니다. :values.',
    ...
    'in_array' => ':attribute은(는) :other에 존재하지 않습니다.',
    'in_array_keys' => ':attribute은(는) 다음 중 하나 이상의 키를 포함해야 합니다: :values.',
    ...
    'max' => [
        ...
        'file' => ':attribute은(는) :max킬로바이트 이하여야 합니다.',
        'numeric' => ':attribute은(는) :max 이하여야 합니다.',
        'string' => ':attribute은(는) :max자 이하여야 합니다.',
    ],
    'max_digits' => ':attribute은(는) :max자리를 넘지 않아야 합니다.',
    'mimes' => ':attribute은(는) 다음의 파일 형식이어야 합니다: :values.',
    'mimetypes' => ':attribute은(는) 다음의 파일 형식이어야 합니다: :values.',
    'min' => [
        'array' => ':attribute은(는) :min개 이상의 항목이 있어야 합니다.',
        'file' => ':attribute은(는) :min킬로바이트 이상이어야 합니다.',
        'numeric' => ':attribute은(는) :min 이상이어야 합니다.',
        'string' => ':attribute은(는) :min자 이상이어야 합니다.',
    ],
    'min_digits' => ':attribute은(는) :min자리 이상이어야 합니다.',
    'missing' => ':attribute(이)가  없어야 합니다.',
    'missing_if' => ':Other이 :value일 때 :attribute은(는) 누락되어야 합니다.',
    'missing_unless' => ':Other이 :value이 아닌 경우 :attribute은(는) 누락되어야 합니다.',
    'missing_with' => ':Values이 있는 경우 :attribute은(는) 누락되어야 합니다.',
    'missing_with_all' => ':Values이 있는 경우 :attribute은(는) 누락되어야 합니다.',
    ...
    'password' => [
        ...
        'mixed' => ':attribute은(는) 적어도 하나의 대문자와 하나의 소문자를 포함해야 합니다.',
        'numbers' => ':attribute은(는) 적어도 하나의 숫자를 포함해야 합니다.',
        'symbols' => ':attribute은(는) 적어도 하나의 기호를 포함해야 합니다.',
        'uncompromised' => '주어진 :attribute이 데이터 유출로 나타났습니다. 다른 :attribute개를 선택하세요.',
    ],
    'phone' => ':attribute의 형식이 올바르지 않습니다.',
    'present' => ':attribute(이)가  있어야 합니다.',
    'present_if' => ':other이 :value인 경우 :attribute(이)가  있어야 합니다.',
    'present_unless' => ':other이 :value이 아닌 이상 :attribute(이)가  있어야 합니다.',
    'present_with' => ':values이 있으면 :attribute도 있어야 합니다.',
    'present_with_all' => ':values이 있을 때 :attribute도 있어야 합니다.',
    'prohibited' => ':attribute (은)는 금지되어 있습니다.',
    'prohibited_if' => ':attribute (은)는 :other 이(가) :value 인 경우 금지되어 있습니다.',
    'prohibited_if_accepted' => ':attribute은(는) :other이 허용되면 금지됩니다.',
    'prohibited_if_declined' => ':other이 감소 할 때 :attribute은(는) 금지됩니다.',
    ...
    'required_array_keys' => ':attribute은(는) :values에 대한 항목을 포함해야 합니다.',
    'required_if' => ':Other이(가) :value 일 때 :attribute은(는) 필수입니다.',
    'required_if_accepted' => ':Other이 승인되면 :attribute(이)가  필요합니다.',
    'required_if_declined' => ':other이 거부되는 경우 :attribute(이)가  필요합니다.',
    'required_unless' => ':Other이(가) :values에 없다면 :attribute은(는) 필수입니다.',
    'required_with' => ':values이(가) 있는 경우 :attribute은(는) 필수입니다.',
    'required_with_all' => ':values이(가) 모두 있는 경우 :attribute은(는) 필수입니다.',
    'required_without' => ':values이(가) 없는 경우 :attribute은(는) 필수입니다.',
    'required_without_all' => ':values이(가) 모두 없는 경우 :attribute은(는) 필수입니다.',
